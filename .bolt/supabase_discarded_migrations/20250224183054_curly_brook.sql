/*
  ...
  1. Storage
    - Creates meal_plan_images bucket for storing images
    - Sets up appropriate access policies
  
  2. Tables
    - meal_plans: Stores meal plan details with nutritional info
    - notifications: Handles user notifications for new meal plans
